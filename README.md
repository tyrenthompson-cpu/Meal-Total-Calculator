...
My background in cybersecurity gives me a unique perspective as a developer. I don’t just think about how to create features; I think about how to protect them. I enjoy designing applications that are clean, efficient, and resilient, whether I’m working on front‑end interfaces, back‑end logic, or the security layers that hold everything together.

What motivates me most is the blend of creativity and problem‑solving. I love taking an idea, breaking it down into pieces, and turning it into something functional and meaningful. Whether I’m building a new project, learning a new framework, or exploring emerging security trends, I’m always looking for ways to grow and push my skills further.

- 💼 **Current Role**: [Graduate Student and student @ Metana]
- 🎓 **Education**: [B.S. Cybersecurity, CSU Global, and 2026]
- 🌱 **Currently Learning**: [AI and Machine Learning, blockchain, cloud computing]
- 🛠️ **Interests**: [Hip Hop, Classic Rock, foodie, and reading]

Feel free to connect with me via 🔗 [Portfolio](https://github.com/tyrenthompson-cpu) | [LinkedIn](https://linkedin.com/in/tyrenthompson/) | [email](tyren.thompson@csuglobal.edu) for collaboration opportunities!
...
📧 **Email**: tyren.thompson@csuglobal.edu |
[Portfolio](https://github.com/tyrenthompson-cpu) | [LinkedIn](https://linkedin.com/in/tyrenthompson) 
